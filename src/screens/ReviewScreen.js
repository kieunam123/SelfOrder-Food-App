      ...
      <Box className={[styles.main, styles.navy, styles.center]}>
        ...
        <Box className={[styles.center, styles.column]}>
          ...
          <Typography
            ...
            component="h3"
          >
            Chi Tiết Đơn Hàng <br></br> {orderType === 'takeout' ? 'Mang Về' : 'Ăn Tại Quán'}
          </Typography>
        </Box>
                  ...
                  <CardContent>
                    ...
                    <Box className={[styles.row, styles.between]}>
                      <Typography
                        ...
                        component="p"
                      >
                        khuyến mãi đã áp dụng : {orderItem.khuyenmai}
                      </Typography>
                      <Typography
                        variant="body2"
                        color="textPrimary"
      ...
      <Box>
        <Box>
          <Box className={[styles.bordered, styles.space]}>
            Đơn hàng của tôi - {orderType === 'takeout' ? 'Mang Về' : 'Ăn Tại Quán'} | Tax: 
            {taxPrice}VNĐ | Tổng: {totalPrice}VNĐ | Số Lượng: {itemsCount}
          </Box>
          <Box className={[styles.row, styles.around]}>
            <Button
              onClick={() => {
